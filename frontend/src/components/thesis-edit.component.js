...
export default class ThesisEdit extends Component {
    constructor(props) {
        super(props);
...
componentDidMount() {
    console.log("component" +this.props.match.params.user_id);
    axios.get('http://localhost:5000/thesis/'+this.props.match.params.user_id)
    
    .then(response => {
        this.setState ({
            user_id: response.data.user_id,
            thesis_title: response.data.thesis_title,
            thesis_description: response.data.thesis_description,
            thesis_author: response.data.thesis_author, 
            thesis_SV: response.data.thesis_SV,
            thesis_program: response.data.thesis_program,
            thesis_faculty: response.data.thesis_faculty,
            thesis_keyword: response.data.thesis_keyword
...
.then(response => this.setState ({
    ...
    thesis_keyword: response.data.thesis_keyword
        ...
        onSubmit(e) {
            ...
            axios.post('http://localhost:5000/thesis/update/'+this.props.match.params.user_id, newThesis)
                ...
                <form onSubmit={this.onSubmit}>
                    <div class="form-group"><br />
                        ...
                        <div className="form-group">
                            <center>
                            <input type="submit" value="Edit Thesis" className="btn btn-primary" />
                            </center>
                        </div>
